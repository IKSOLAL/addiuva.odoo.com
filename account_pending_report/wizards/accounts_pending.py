...
class ReportAccountPendingXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, records):
        ...
        row_position = self.calculate_data(number_months, tuple(data['wizard']['accounts_g1']), current_datetime, sheet, row_initial, row_position, column_initial, column_position, col_ageing, text_number, text_partners, subtitles, style_sumtot)
        ...
        row_position += 1 #row jump
        row_position = self.calculate_data(number_months, tuple(data['wizard']['accounts_g2']), current_datetime, sheet, row_initial, row_position, column_initial, column_position, col_ageing, text_number, text_partners, subtitles, style_sumtot)
        ...
        row_position += 1 #row jump
        row_position = self.calculate_data(number_months, tuple(data['wizard']['accounts_g3']), current_datetime, sheet, row_initial, row_position, column_initial, column_position, col_ageing, text_number, text_partners, subtitles, style_sumtot)
        ...
        row_position += 1 #row jump
        row_position = self.calculate_data(number_months, tuple(data['wizard']['accounts_g4']), current_datetime, sheet, row_initial, row_position, column_initial, column_position, col_ageing, text_number, text_partners, subtitles, style_sumtot)
