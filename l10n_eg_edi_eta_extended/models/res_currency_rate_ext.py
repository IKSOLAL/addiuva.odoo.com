...
class ResCurrencyRateExt(models.Model):
    ...
    def _compute_company_rate(self):
        if self.company_id.account_fiscal_country_id.code == 'EG':
            ...
            for currency_rate in self:
                ...
                currency_rate.company_rate = (currency_rate.rate or currency_rate._get_latest_rate().rate or 1.0) / last_rate[
                    company]
        ...
        return super()._compute_company_rate
    ...
    def _compute_inverse_company_rate(self):
        ...
        return super()._compute_inverse_company_rate
